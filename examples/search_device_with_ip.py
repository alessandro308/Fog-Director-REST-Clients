...
def search_device_with_ip(ip,token, device_ip):
  url = "https://%s/api/v1/appmgr/devices?limit=10000&offset=0&searchByAnyMatch=%s" % (ip,device_ip)
...
print "searching devices on FD with ip address"
search_device_with_ip(app_mgr_ip,token_id)
